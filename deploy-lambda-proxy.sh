...
LAMBDA_FUNCTION_NAME="LambdaProxy"
LAMBDA_DIR="./lambda-proxy"
ZIP_FILE="lambda_proxy.zip"
...
add_permission_if_not_exists "AllowSignUpExecutionFromAPIGateway" "InvokeFunction" "arn:aws:execute-api:$REGION:$AWS_ACCOUNT_ID:$API_ID/*/POST/signup"
add_permission_if_not_exists "AllowPedidosExecutionFromAPIGateway" "InvokeFunction" "arn:aws:execute-api:$REGION:$AWS_ACCOUNT_ID:$API_ID/*/GET/pedidos"
add_permission_if_not_exists "AllowPedidosIdExecutionFromAPIGateway" "InvokeFunction" "arn:aws:execute-api:$REGION:$AWS_ACCOUNT_ID:$API_ID/*/GET/pedidos/{id}"
add_permission_if_not_exists "AllowProdutosPostExecutionFromAPIGateway" "InvokeFunction" "arn:aws:execute-api:$REGION:$AWS_ACCOUNT_ID:$API_ID/*/POST/produtos"
add_permission_if_not_exists "AllowProdutosGetIdExecutionFromAPIGateway" "InvokeFunction" "arn:aws:execute-api:$REGION:$AWS_ACCOUNT_ID:$API_ID/*/GET/produtos/{id}"
add_permission_if_not_exists "AllowProdutosGetExecutionFromAPIGateway" "InvokeFunction" "arn:aws:execute-api:$REGION:$AWS_ACCOUNT_ID:$API_ID/*/GET/produtos"
...
integrate_api_gateway "/signup" "POST"
integrate_api_gateway "/login" "POST"
integrate_api_gateway "/produtos" "POST"
integrate_api_gateway "/pedidos" "GET"
integrate_api_gateway "/pedidos/{id}" "GET"
integrate_api_gateway "/produtos" "GET"
integrate_api_gateway "/produtos/{id}" "GET"
